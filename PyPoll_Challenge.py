...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if county_name not in list_counties:
            ...
            dict_county_votes[county_name] = 0

        # 5: Add a vote to that county's vote count.
        dict_county_votes[county_name] += 1
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in dict_county_votes:
        # 6b: Retrieve the county vote count.
        votes = dict_county_votes[county_name]
    ...
    largest_turnout_summary = (
        f"---------------------------------------------\n"
        f"County with largest turnout is {largest_turnout_county} ({largest_turnout_count:,} votes)\n"
        f"---------------------------------------------\n")
